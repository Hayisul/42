...
/*   Updated: 2024/11/04 19:41:06 by rantonia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_ft_memset_basic(void *ptr)
{
	...
	SANDBOX_RAISE(const int size = 20; char b1[BSIZE]; char b2[BSIZE];
					memset(b1, 'B', BSIZE);
					memset(b2, 'B', BSIZE);
					memset(b1, 'A', size);
					ft_memset(b2, 'A', size);
					if (!memcmp(b1, b2, BSIZE)) exit(TEST_SUCCESS);
...
void	test_ft_memset_unsigned(void *ptr)
{
	...
	SANDBOX_RAISE(const int size = 22; char b1[BSIZE]; char b2[BSIZE];
					memset(b1, 'B', BSIZE);
					memset(b2, 'B', BSIZE);
					memset(b1, '\200', size);
...
void	test_ft_memset_return(void *ptr)
{
	...
	SANDBOX_RAISE(const int size = 18; char b1[BSIZE];
					memset(b1, 'B', BSIZE);
					r1 = memset(b1, 'A', size);
...
void	test_ft_memset_fat(void *ptr)
{
	typeof(memset) *ft_memset = ptr;
	SET_EXPLANATION("basic memset test (fill a buffer with 'A')");
	SANDBOX_RAISE(char *b1 = (char *)malloc(sizeof(char) * (BFSIZE
				+ 1)); char *b2 = (char *)malloc(sizeof(char) * (BFSIZE + 1));
					*b1 = 0;
					*b2 = 0;
					memset(b1, '\5', BFSIZE);
...
void	test_ft_memset_null(void *ptr)
{
	...
	SANDBOX_IRAISE(ft_memset(NULL, 'a', 12););
}
...
void	test_ft_memset_zero_value(void *ptr)
{
	...
	SANDBOX_RAISE(char buff[BSIZE]; char buff2[BSIZE];
					memset(buff, 0, sizeof(buff));
					memset(buff2, 0, sizeof(buff2));
					ft_memset(buff, '\xff', 0);
					memset(buff2, '\xff', (0));
					if (!memcmp(buff, buff2, BSIZE)) exit(TEST_SUCCESS);
					SET_DIFF(buff, buff2);
					exit(TEST_FAILED););
}
...
void	test_ft_memset_electric_memory(void *ptr)
{
	...
	SANDBOX_RAISE(const size_t size = 10; char *buff = electric_alloc(size);
					memset(buff, 0, size);
...
{
	typeof(memset) *ft_memset = ptr;
	SANDBOX_SPEED(size_t size = BFSIZE
		* 16; char *b1 = (char *)malloc(sizeof(char)
			* size); char *b2 = (char *)malloc(sizeof(char) * size);, memset(b1,
			'A', size);, ft_memset(b2, 'A', size););
}
...
void	test_ft_bzero_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char str[BSIZE]; char str2[BSIZE];
					memset(str, 'a', BSIZE);
					memset(str2, 'a', BSIZE);
					bzero(str, 20);
					ft_bzero(str2, 20);
					if (!memcmp(str, str2, BSIZE)) exit(TEST_SUCCESS);
...
void	test_ft_bzero_null(void *ptr)
{
	...
	SANDBOX_IRAISE(ft_bzero(NULL, 0x12););
}
...
void	test_ft_bzero_speed(void *ptr)
{
	typeof(bzero) *ft_bzero = ptr;
	SANDBOX_SPEED(size_t size = BFSIZE
		* 4; char *str = (char *)malloc(sizeof(char)
			* size); char *str2 = (char *)malloc(sizeof(char) * size);
					memset(str, 'a', size);
					memset(str2, 'a', size);
					, bzero(str, size);
					, ft_bzero(str2, size););
...
void	test_ft_memcpy_basic_test(void *ptr)
{
	...
	SANDBOX_RAISE(char src[] = "test basic du memcpy !"; char buff1[22]; char buff2[22];
					memcpy(buff1, src, 22);
					ft_memcpy(buff2, src, 22);
					if (!memcmp(buff1, buff2, 22)) exit(TEST_SUCCESS);
...
void	test_ft_memcpy_return(void *ptr)
{
	...
	SANDBOX_RAISE(char src[] = "test basic du memcpy !"; char buff1[22];
...
void	test_ft_memcpy_zero_value(void *ptr)
{
	...
	SANDBOX_RAISE(char buff[] = "test 0 du memcpy !"; char *src = STRING_4; char buff2[] = STRING_4;
					ft_memcpy(buff2, buff, 0);
					if (!memcmp(src, buff2, strlen(buff2))) exit(TEST_SUCCESS);
					SET_DIFF(src, buff2);
					exit(TEST_FAILED););
}
...
void	test_ft_memcpy_basic_test2(void *ptr)
{
	...
	SANDBOX_RAISE(char src[] = STRING_3; char buff1[] = STRING_1; char buff2[] = STRING_1;
					memcpy(buff1, src, strlen(src));
					ft_memcpy(buff2, src, strlen(src));
					if (!memcmp(buff1, buff2,
							strlen(buff2))) exit(TEST_SUCCESS);
					SET_DIFF(buff1, buff2);
					exit(TEST_FAILED););
}
...
void	test_ft_memcpy_to_small(void *ptr)
{
	...
	SANDBOX_IRAISE(ft_memcpy("", "segfaulter tu dois", 17););
}
...
void	test_ft_memcpy_struct(void *ptr)
{
	...
	src = {"nyancat® inside", (void *)0xdeadbeef, 0x42424242424242L,
		0b1010100010};
	SANDBOX_RAISE(char buff1[0xF00]; char buff2[0xF00];
...
void	test_ft_memcpy_electric_memory(void *ptr)
{
	...
	SANDBOX_RAISE(const size_t size = 10; char *src = electric_alloc(size); char *buff = electric_alloc(size);
...
void	test_ft_memcpy_null1(void *ptr)
{
	...
	SANDBOX_IRAISE(ft_memcpy(NULL, "segfaulter tu dois", 17););
}
...
void	test_ft_memcpy_null2(void *ptr)
{
	...
	SANDBOX_IRAISE(ft_memcpy("            ", NULL, 17););
}
...
void	test_ft_memcpy_double_null1(void *ptr)
{
	...
	SANDBOX_RAISE(ft_memcpy(NULL, NULL, 0););
}
...
void	test_ft_memcpy_double_null2(void *ptr)
{
	...
	SANDBOX_RAISE(ft_memcpy(NULL, NULL, 3););
}

void	test_ft_memcpy_speed(void *ptr)
{
	typeof(memcpy) *ft_memcpy = ptr;
	SANDBOX_SPEED(size_t size = BFSIZE * 16; char *src = malloc(size
			+ 1); char *buff1 = malloc(size + 1);
					memset(src, 'A', size);
...
void	test_ft_memmove_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "this is a good nyancat !\r\n"; char dst1[0xF0]; char dst2[0xF0]; int size = strlen(src);
					memmove(dst1, src, size);
					ft_memmove(dst2, src, size);
					if (!memcmp(dst1, dst2, size)) exit(TEST_SUCCESS);
					SET_DIFF(dst1, dst2);
					exit(TEST_FAILED););
}
...
void	test_ft_memmove_return(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "thanks to @apellicc for this test !\r\n"; char dst1[0xF0]; int size = strlen(src);
...
void	test_ft_memmove_null_byte(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "thi\xffs i\xfas \0a g\xde\xadood \0nyan\0cat\0 !\r\n"; int size = 33; char dst1[0xF0]; char dst2[0xF0];
					memmove(dst1, src, size);
					ft_memmove(dst2, src, size);
					if (!memcmp(dst1, dst2, size)) exit(TEST_SUCCESS);
					SET_DIFF(dst1, dst2);
...
void	test_ft_memmove_long_int(void *ptr)
{
	...
	SANDBOX_RAISE(unsigned long src = 0xdeadbeef; int size = sizeof(src); unsigned long dst1; unsigned long dst2;
					memmove(&dst1, &src, size);
					ft_memmove(&dst2, &src, size);
					if (!memcmp(&dst1, &dst2, size)) exit(TEST_SUCCESS);
					exit(TEST_FAILED););
...
void	test_ft_memmove_overlap(void *ptr)
{
	...
	SANDBOX_RAISE(char dst1[0xF0]; char dst2[0xF0]; char *data = "thiß ß\xde\xad\xbe\xeftriñg will be øvérlapéd !\r\n"; int size = 0xF0
		- 0xF;
...
void	test_ft_memmove_hard(void *ptr)
{
	...
	SANDBOX_RAISE(int size = 128 * 1024
		* 1024; char *dst = (char *)malloc(sizeof(char)
			* size); char *data = (char *)malloc(sizeof(char) * size);
					memset(data, 'A', size);
					if (!dst) exit(TEST_INVISIBLE);
...
void	test_ft_memmove_electric_memory(void *ptr)
{
	...
	SANDBOX_RAISE(int size = 10; char *dst = electric_alloc(size); char *data = electric_alloc(size);
					memset(data, 'A', size);
...
void	test_ft_memmove_double_null1(void *ptr)
{
	...
	SANDBOX_RAISE(ft_memmove(NULL, NULL, 0););
}
...
void	test_ft_memmove_double_null2(void *ptr)
{
	...
	SANDBOX_RAISE(ft_memmove(NULL, NULL, 5););
}
...
void	test_ft_memmove_same_pointer(void *ptr)
{
	...
	SANDBOX_RAISE(char data1[] = STRING_1; char data2[] = STRING_1; int size = strlen(STRING_1);
					memmove(data1, data1, size);
					ft_memmove(data2, data2, size);
					if (!memcmp(data1, data2, size)) exit(TEST_SUCCESS);
...
void	test_ft_memmove_malloc(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = STRING_1; char buff[0xF0];
					MALLOC_NULL;
...
{
	typeof(memmove) *ft_memmove = ptr;
	SANDBOX_SPEED(int size = BFSIZE
		* 128; char *dst = (char *)malloc(sizeof(char)
			* size); char *data = (char *)malloc(sizeof(char) * size);
					memset(data, 'A', size);
...
void	test_ft_memchr_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "/|\x12\xff\x09\x42\042\42|\\"; int size = 10;
					if (memchr(src, '\x42', size) == ft_memchr(src, '\x42',
							size)) exit(TEST_SUCCESS);
					SET_DIFF(memchr(src, '\x42', size), ft_memchr(src, '\x42',
							size)) exit(TEST_FAILED););
}
...
void	test_ft_memchr_unsigned(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "/|\x12\xff\x09\x42\2002\42|\\"; int size = 10;
					if (memchr(src, '\200', size) == ft_memchr(src, '\200',
							size)) exit(TEST_SUCCESS);
					SET_DIFF(memchr(src, '\200', size), ft_memchr(src, '\200',
							size));
					exit(TEST_FAILED););
}
...
void	test_ft_memchr_not_found1(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "/|\x12\xff\x09\x42\042\42|\\"; int size = 2;
					if (memchr(src, '\x42', size) == ft_memchr(src, '\x42',
							size)) exit(TEST_SUCCESS);
					SET_DIFF(memchr(src, '\x42', size), ft_memchr(src, '\x42',
							size)) exit(TEST_FAILED););
...
void	test_ft_memchr_not_found2(void *ptr)
{
	...
	SET_EXPLANATION("your memchr does not work");
	SANDBOX_RAISE(char *src = "/|\x12\xff\x09\x42\042\42|\\"; int size = 10;
					if (memchr(src, '\xde', size) == ft_memchr(src, '\xde',
							size)) exit(TEST_SUCCESS);
					SET_DIFF(memchr(src, '\xde', size), ft_memchr(src, '\xde',
							size));
					exit(TEST_FAILED););
}
...
void	test_ft_memchr_faraway(void *ptr)
{
	...
	SANDBOX_RAISE(char src[] = "iawhf\200wf208awfh\xakufi21f4\x42w7fwa1f";
					if (memchr(src, '\x42', sizeof(src)) == ft_memchr(src,
							'\x42', sizeof(src))) exit(TEST_SUCCESS);
					exit(TEST_FAILED););
}
...
void	test_ft_memchr_electric_memory(void *ptr)
{
	...
	SANDBOX_RAISE(int size = 15; char *src = electric_alloc(size);
					strcpy(src, ":(){ :|: & };:");
					mprotect(src - 4096 + size, 4096, PROT_READ);
...
void	test_ft_memchr_null_byte(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "/|\x12\xff\x09\0\x42\042\0\42|\\"; int size = 12;
					if (memchr(src, '\0', size) == ft_memchr(src, '\0',
							size)) exit(TEST_SUCCESS);
					exit(TEST_FAILED););
}
...
void	test_ft_memchr_null(void *ptr)
{
	...
	SANDBOX_IRAISE(ft_memchr(NULL, '\0', 0x20););
}
...
void	test_ft_memcmp_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "\xff\xaa\xde\x12MACOSX"; char *s2 = "\xff\xaa\xde\x12MACOSX"; size_t size = 10;
...
void	test_ft_memcmp_basic1(void *ptr)
{
	...
	typeof(memcmp) *ft_memcmp = ptr;
	SET_EXPLANATION("your memcmp does not work with basic input");
	SANDBOX_RAISE(char *s1 = "\xff\xaa\xde\x12WXYZ"; char *s2 = "\xff\xaa\xde\x12MACOSX"; size_t size = 7;
					// macos memcmp function return 1 or -1 in this case,
						Apple why ?
...
void	test_ft_memcmp_basic2(void *ptr)
{
	...
	typeof(memcmp) *ft_memcmp = ptr;
	SET_EXPLANATION("your memcmp does not work with basic input");
	SANDBOX_RAISE(char *s1 = "\xff\xaa\xde\x12"; char *s2 = "\xff\xaa\xde\x12MACOSAAAAA"; size_t size = 4;
					i1 = LREG(simple_memcmp(s1, s2, size));
					i2 = LREG(ft_memcmp(s1, s2, size));
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_memcmp_basic3(void *ptr)
{
	...
	typeof(memcmp) *ft_memcmp = ptr;
	SET_EXPLANATION("your memcmp does not work with basic input");
	SANDBOX_RAISE(char *s1 = "\xff\xaa\xde\xffMACOSX\xff"; char *s2 = "\xff\xaa\xde\x02"; size_t size = 8;
					i1 = LREG(simple_memcmp(s1, s2, size));
					i2 = LREG(ft_memcmp(s1, s2, size));
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_memcmp_hidden(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "atoms\0\0\0\0"; char *s2 = "atoms\0abc"; size_t size = 8;
					i1 = LREG(simple_memcmp(s1, s2, size));
					i2 = LREG(ft_memcmp(s1, s2, size));
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_memcmp_unsigned(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "\xff\xaa\xde\200"; char *s2 = "\xff\xaa\xde\0"; size_t size = 8;
					i1 = LREG(simple_memcmp(s1, s2, size));
					i2 = LREG(ft_memcmp(s1, s2, size));
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_memcmp_null_byte(void *ptr)
{
	...
	typeof(memcmp) *ft_memcmp = ptr;
	SET_EXPLANATION("your memcmp does not work with basic input");
	SANDBOX_RAISE(char *s1 = "\xff\0\0\xaa\0\xde\xffMACOSX\xff"; char *s2 = "\xff\0\0\xaa\0\xde\x00MBS"; size_t size = 9;
					i1 = LREG(simple_memcmp(s1, s2, size));
					i2 = LREG(ft_memcmp(s1, s2, size));
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_memcmp_electric_memory(void *ptr)
{
	...
	SANDBOX_RAISE(size_t size = 10; char *b1 = electric_alloc(size); char *b2 = electric_alloc(size);
					strcpy(b1, ".........");
					strcpy(b2, ".........");
...
void	test_ft_memcmp_null1(void *ptr)
{
	...
	SANDBOX_IRAISE(char b1[] = "nyancat";
					ft_memcmp(NULL, b1, 4););
}
...
void	test_ft_memcmp_speed(void *ptr)
{
	typeof(memcmp) *ft_memcmp = ptr;
	SET_EXPLANATION("your memcmp does not cast the memory in unsigned char");
	SANDBOX_SPEED(size_t size = BFSIZE * 16; char *s1 = malloc(sizeof(char)
			* size); char *s2 = malloc(sizeof(char) * size);
					memset(s1, 'A', size);
					memset(s2, 'A', size);
					, memcmp(s1, s2, size);
...
void	test_ft_strlen_basic(void *ptr)
{
	...
	SANDBOX_RAISE(int r1; int r2; char *str = "sais-tu compter ?";
...
void	test_ft_strlen_random(void *ptr)
{
	typeof(strlen) *ft_strlen = ptr;
	SET_EXPLANATION("your strlen doesn't work with basic test");
	SANDBOX_RAISE(int r1; int r2; char buff[0x100]; int offset; int rnd_fd = open("/dev/urandom",
			O_RDONLY); const int test_count = 9001;
					if (rnd_fd < 0) exit(TEST_SUCCESS);
					for (int i = 0; i < test_count; i++) if (read(rnd_fd, buff,
							sizeof(buff)) > 0) {
						offset = rand() % sizeof(buff);
						buff[sizeof(buff) - 1] = 0;
						if ((r1 = ft_strlen(buff + offset)) != (r2 = strlen(buff
									+ offset)))
						{
							SET_DIFF_INT(r1, r2);
							exit(TEST_FAILED);
...
void	test_ft_strlen_bad_opti(void *ptr)
{
	...
	SANDBOX_RAISE(int r1; int r2; const char *str = "01234567, AAAAAA,
		abc\xba e, ......, end of string !";
					if ((r1 = ft_strlen(str)) != (r2 = strlen(str))) {
						SET_DIFF_INT(r1, r2);
						exit(TEST_FAILED);
					} exit(TEST_SUCCESS););
...
void	test_ft_strlen_unicode(void *ptr)
{
	...
	SANDBOX_RAISE(int r1; int r2; char *str = "♫♪.ılılıll|̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅|llılılı.♫♪";
					if ((r1 = ft_strlen(str)) != (r2 = strlen(str))) {
						SET_DIFF_INT(r1, r2);
						exit(TEST_FAILED);
					} exit(TEST_SUCCESS););
...
void	test_ft_strlen_empty(void *ptr)
{
	...
	SANDBOX_RAISE(
		if (ft_strlen("")) exit(TEST_FAILED); exit(TEST_SUCCESS);
	);
}
...
void	test_ft_strlen_zero(void *ptr)
{
	...
	SANDBOX_RAISE(int r1; int r2; const char *s = "HAHAHAHA \0 TA FAIL XD";
...
void	test_ft_strlen_electric_memory(void *ptr)
{
	...
	SANDBOX_RAISE(const size_t size = 37; char *s = electric_alloc(size);
...
void	test_ft_strlen_little(void *ptr)
{
	...
	SANDBOX_RAISE(int r1; int r2; const char *s = "YOLO";
					if ((unsigned long)s & 0b111) s++;
					if ((r2 = ft_strlen(s)) != (r1 = strlen(s))) {
						SET_DIFF_INT(r1, r2)
						exit(TEST_FAILED);
					} exit(TEST_SUCCESS););
...
{
	typeof(strlen) *ft_strlen = ptr;
	SANDBOX_SPEED(size_t size = BFSIZE * 16; char *str = malloc(size + 1);
					memset(str, 'A', size);
					str[size] = 0;
					, strlen(str);
					, ft_strlen(str););
...
void	test_ft_strdup_last_char(void *ptr)
{
	...
	SANDBOX_RAISE(char *str; char *tmp = "HAHAHA \0 tu me vois pas !";
					MALLOC_MEMSET;
					str = ft_strdup(tmp);
					MALLOC_RESET;
					if (strcmp(str, tmp)) exit(TEST_FAILED);
					free(str);
					exit(TEST_SUCCESS););
}
...
void	test_ft_strdup_zero(void *ptr)
{
	...
	SANDBOX_RAISE(char *str; char *tmp = "";
					str = ft_strdup(tmp);
					if (strcmp(str, tmp)) exit(TEST_FAILED);
					free(str);
					exit(TEST_SUCCESS););
...
void	test_ft_strdup_size(void *ptr)
{
	...
	SANDBOX_RAISE(char *tmp = "this is a normal test"; int r_size = strlen(tmp); int size;
					MALLOC_SIZE;
					ft_strdup(tmp);
					MALLOC_RESET;
					size = get_last_malloc_size();
					if (size == r_size + 1) exit(TEST_SUCCESS);
...
void	test_ft_strdup_malloc_null(void *ptr)
{
	...
	SANDBOX_RAISE(char *ptr;
					MALLOC_NULL;
					ptr = ft_strdup("lol");
					MALLOC_RESET;
					if (!ptr) exit(TEST_SUCCESS);
...
void	test_ft_strdup_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *str; char *tmp = "I malloc so I am.";
					str = ft_strdup(tmp);
					if (strcmp(str, tmp)) exit(TEST_FAILED);
					free(str);
					exit(TEST_SUCCESS););
...
void	test_ft_strdup_electric_memory(void *ptr)
{
	...
	SANDBOX_RAISE(char *tmp = electric_alloc(10);
...
void	test_ft_calloc_free(void *ptr)
{
	...
	SANDBOX_RAISE(free(ft_calloc(42, 1)););
}
...
void	test_ft_calloc_zero(void *ptr)
{
	...
	SANDBOX_RAISE(void *str = ft_calloc(0,
			0); if (str == NULL) exit(TEST_FAILED); free(str); exit(TEST_SUCCESS););
}
...
void	test_ft_calloc_basic(void *ptr)
{
	...
	SANDBOX_RAISE(int size = 8539;
					MALLOC_MEMSET;
					d1 = ft_calloc(size, sizeof(int));
					MALLOC_RESET;
					d2 = calloc(size, sizeof(int));
					if (memcmp(d1, d2, size * sizeof(int))) exit(TEST_FAILED);
					free(d1);
					free(d2);
					exit(TEST_SUCCESS););
}
...
void	test_ft_calloc_size(void *ptr)
{
	...
	SANDBOX_RAISE(int size; int count = 42 * 3;
					MALLOC_SIZE;
					ft_calloc(count, sizeof(char));
					MALLOC_RESET;
					size = get_last_malloc_size();
					if (size == count * sizeof(char)) exit(TEST_SUCCESS);
...
void	test_ft_calloc_too_big(void *ptr)
{
	...
	SANDBOX_RAISE(void *d1 = ft_calloc(ULONG_MAX,
			sizeof(char)); void *d2 = ft_calloc(2, 1073741829);
		// overflow the int max
					d3 = ft_calloc(1, ULONG_MAX);
					if (d1 || d3 || !d2) exit(TEST_FAILED);
					exit(TEST_SUCCESS););
}
...
void	test_ft_strcpy_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "--> nyancat <--\n\r"; char dst1[30]; char dst2[30];
					memset(dst1, 'A', sizeof(dst1));
					memset(dst2, 'A', sizeof(dst2));
					strcpy(dst1, src);
					ft_strcpy(dst2, src);
...
void	test_ft_strcpy_unicode(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "œð˛ʼˇ,´˛ˀ-ºª•¶ªˆ§´"; char dst1[80]; char dst2[80];
					memset(dst1, 'a', sizeof(dst1));
					memset(dst2, 'a', sizeof(dst2));
					strcpy(dst1, src);
					ft_strcpy(dst2, src);
...
void	test_ft_strcpy_overflow(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "AAAA"; char dst1[80]; char dst2[80];
...
void	test_ft_strcpy_zero(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "zero test !"; char dst1[80]; size_t len = strlen(src);
					memset(dst1, 'A', 79);
					ft_strcpy(dst1, src);
					if (dst1[len]) {
						SET_DIFF(src, dst1);
...
void	test_ft_strcpy_empty(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = ""; char dst1[30]; char dst2[30];
					memset(dst1, 'B', sizeof(dst1));
					memset(dst2, 'B', sizeof(dst2));
					strcpy(dst1, src);
					ft_strcpy(dst2, src);
...
void	test_ft_strcpy_electric_memory(void *ptr)
{
	...
	SANDBOX_RAISE(const size_t size = 10; char *src = "AAAAAAAAB"; char *dst = electric_alloc(size);
					mprotect(dst - 4096 + size, 4096, PROT_WRITE);
					ft_strcpy(dst, src);
					exit(TEST_SUCCESS););
}
...
void	test_ft_strcpy_null1(void *ptr)
{
	...
	SANDBOX_IRAISE(ft_strcpy(NULL, "olol"););
}
...
{
	typeof(strcpy) *ft_strcpy = ptr;
	SANDBOX_SPEED(size_t size = BFSIZE * 2; char *src = malloc(size
			+ 1); char *dst = malloc(size + 1);
					memset(src, 'A', size);
					src[size] = 0;
					, strcpy(dst, src);
					, ft_strcpy(dst, src););
...
void	test_ft_strncpy_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "--> nyancat <--\n\r"; char dst1[30]; char dst2[30]; size_t max = 12;
					memset(dst1, 'B', sizeof(dst1));
					memset(dst2, 'B', sizeof(dst2));
...
void	test_ft_strncpy_unicode(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "œð˛ʼˇ,´˛ˀ-ºª•¶ªˆ§´"; char dst1[80]; char dst2[80]; size_t max = 16;
					memset(dst1, 'B', sizeof(dst1));
					memset(dst2, 'B', sizeof(dst2));
					strncpy(dst1, src, max);
					ft_strncpy(dst2, src, max);
...
void	test_ft_strncpy_empty(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = ""; char dst1[30]; char dst2[30]; size_t max = 29;
					memset(dst1, 'B', sizeof(dst1));
					memset(dst2, 'B', sizeof(dst2));
					strncpy(dst1, src, max);
					ft_strncpy(dst2, src, max);
...
void	test_ft_strncpy_zero(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "this is a string with a \0 inside"; char dst1[50]; char dst2[50]; size_t max = 31;
					memset(dst1, 'B', sizeof(dst1));
					memset(dst2, 'B', sizeof(dst2));
					strncpy(dst1, src, max);
					ft_strncpy(dst2, src, max);
...
void	test_ft_strncpy_fill(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "stars"; char dst1[50]; char dst2[50]; size_t max = 50;
					memset(dst1, 'B', sizeof(dst1));
					memset(dst2, 'B', sizeof(dst2));
					strncpy(dst1, src, max);
					ft_strncpy(dst2, src, max);
...
void	test_ft_strncpy_number_0(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "len\0AAAAAAAAAAAA"; char dst1[] = "BBBBBBBBBBBBBBBBBBBB"; char dst2[] = "BBBBBBBBBBBBBBBBBBBB"; size_t len = strlen(dst1);
					strncpy(dst1, src, 7);
...
void	test_ft_strncpy_final_0(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "AAAAAAAAAAAA"; char dst1[] = "BBBBBBBBBBBBBBBBBBBB"; char dst2[] = "BBBBBBBBBBBBBBBBBBBB"; size_t len = strlen(dst1);
					strncpy(dst1, src, 2);
...
void	test_ft_strncpy_electric_memory(void *ptr)
{
	...
	SANDBOX_RAISE(const size_t size = 10; char *src = electric_alloc(size); char *dst = electric_alloc(size);
					strcpy(src, "ASSEMBLY.");
					mprotect(src - 4096 + size, 4096, PROT_READ);
					mprotect(dst - 4096 + size, 4096, PROT_WRITE);
...
void	test_ft_strncpy_null1(void *ptr)
{
	...
	SANDBOX_IRAISE(ft_strncpy(NULL, "olol", 3););
}
...
void	test_ft_strcat_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = STRING_1; char buff1[0xF00] = STRING_2; char buff2[0xF00] = STRING_2;
					strcat(buff1, str);
					ft_strcat(buff2, str);
					if (!strcmp(buff1, buff2)) exit(TEST_SUCCESS);
					SET_DIFF(buff1, buff2);
					exit(TEST_FAILED););
}
...
void	test_ft_strcat_return(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = STRING_1; char *str2 = "yolo !"; char buff1[0xF00] = STRING_2;
					r1 = strcat(buff1, str);
...
void	test_ft_strcat_unicode(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = "こんにちは"; char buff1[0xF00] = "=>"; char buff2[0xF00] = "=>";
					r1 = strcat(buff1, str);
					r2 = ft_strcat(buff2, str);
					if (!strcmp(r1, r2)) exit(TEST_SUCCESS);
					SET_DIFF(r1, r2);
					exit(TEST_FAILED););
}
...
void	test_ft_strcat_overflow(void *ptr)
{
	...
	SANDBOX_RAISE(const char *str = "AAAA"; char buff1[0xF0]; char buff2[0xF0];
					memset(buff1, 'B', 30);
					memset(buff2, 'B', 30);
					buff1[4] = 0;
					buff2[4] = 0;
					r1 = strcat(buff1, str);
					r2 = ft_strcat(buff2, str);
					if (!memcmp(r1, r2, 20)) exit(TEST_SUCCESS);
...
void	test_ft_strcat_empty1(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = ""; char buff1[0xF00] = STRING_2; char buff2[0xF00] = STRING_2; char *r1; char *r2;
					r1 = strcat(buff1, str);
					r2 = ft_strcat(buff2, str);
					if (!strcmp(buff1, buff2) && ((buff1 - r1) == (buff2
								- r2))) exit(TEST_SUCCESS);
					SET_DIFF(buff1, buff2);
					if (r1 != r2) SET_DIFF(r1, r2);
					exit(TEST_FAILED););
}
...
void	test_ft_strcat_empty2(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = STRING_1; char buff1[0xF00] = ""; char buff2[0xF00] = "";
					strcat(buff1, str);
					ft_strcat(buff2, str);
					if (!strcmp(buff1, buff2)) exit(TEST_SUCCESS);
					SET_DIFF(buff1, buff2);
...
void	test_ft_strcat_null_byte(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = "n\0AAAAAAAAAAAAAAAAA"; char buff1[0xF00] = "\0AAAAAAAAAAAAAAAA"; char buff2[0xF00] = "\0AAAAAAAAAAAAAAAA";
					strcat(buff1, str);
					ft_strcat(buff2, str);
					if (!strcmp(buff1, buff2)) exit(TEST_SUCCESS);
					SET_DIFF(buff1, buff2);
...
void	test_ft_strcat_electric_memory(void *ptr)
{
	...
	SANDBOX_RAISE(const size_t size = 10; char *str = electric_alloc(size); char *buff = electric_alloc(size);
					strcpy(buff, "AB");
					strcpy(str, "CDEFGHI");
...
void	test_ft_strcat_null1(void *ptr)
{
	...
	SANDBOX_IRAISE(char b[0xF] = "nyan !";
					ft_strcat(NULL, b););
}
...
void	test_ft_strcat_speed(void *ptr)
{
	typeof(strcat) *ft_strcat = ptr;
	SET_EXPLANATION("your strcat does not set a \\0 to the end");
	SANDBOX_SPEED(size_t size = BFSIZE * 4; char *str = malloc(size
			+ 1); char *buff1 = malloc(size + 1); char *buff2 = malloc(size
			+ 1);
					*buff1 = 0;
					*buff2 = 0;
					memset(str, 'A', size);
...
void	test_ft_strncat_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = STRING_1; char buff1[0xF00] = STRING_2; char buff2[0xF00] = STRING_2; size_t max = 5;
...
void	test_ft_strncat_return(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = STRING_1; char buff1[0xF00] = STRING_2; size_t max = 5;
...
void	test_ft_strncat_basic2(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = STRING_1; char buff1[0xF00] = STRING_2; char buff2[0xF00] = STRING_2; size_t max = 1000;
					strncat(buff1, str, max);
					ft_strncat(buff2, str, max);
					if (!strcmp(buff1, buff2)) exit(TEST_SUCCESS);
					SET_DIFF(buff1, buff2);
...
void	test_ft_strncat_unicode(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = "こんにちは"; char buff1[0xF00] = "こんにちは"; char buff2[0xF00] = "こんにちは"; size_t max = 1000;
					strncat(buff1, str, max);
					ft_strncat(buff2, str, max);
					if (!strcmp(buff1, buff2)) exit(TEST_SUCCESS);
					SET_DIFF(buff1, buff2);
...
void	test_ft_strncat_empty1(void *ptr)
{
	typeof(strncat) *ft_strncat = ptr;
	SET_EXPLANATION("your strcat does not work with empty string as first parameter");
	SANDBOX_RAISE(char *str = ""; char buff1[0xF00] = STRING_2; char buff2[0xF00] = STRING_2; size_t max = 5;
					strncat(buff1, str, max);
					ft_strncat(buff2, str, max);
					if (!strcmp(buff1, buff2)) exit(TEST_SUCCESS);
					SET_DIFF(buff1, buff2);
...
void	test_ft_strncat_empty2(void *ptr)
{
	typeof(strncat) *ft_strncat = ptr;
	SET_EXPLANATION("your strcat does not work with empty string as second parameter");
	SANDBOX_RAISE(char *str = STRING_1; char buff1[0xF00] = ""; char buff2[0xF00] = ""; size_t max = 5;
					strncat(buff1, str, max);
					ft_strncat(buff2, str, max);
					if (!strcmp(buff1, buff2)) exit(TEST_SUCCESS);
					SET_DIFF(buff1, buff2);
...
void	test_ft_strncat_null_byte(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = "n\0AAAAAAAAAAAAAAAAA"; char buff1[0xF00] = "\0AAAAAAAAAAAAAAAA"; char buff2[0xF00] = "\0AAAAAAAAAAAAAAAA"; size_t max = 10;
					strncat(buff1, str, max);
					ft_strncat(buff2, str, max);
					if (!strcmp(buff1, buff2)) exit(TEST_SUCCESS);
					SET_DIFF(buff1, buff2);
...
void	test_ft_strlcat_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = STRING_1; char buff1[0xF00] = STRING_2; char buff2[0xF00] = STRING_2; size_t max = strlen(STRING_1)
		+ 4;
...
void	test_ft_strlcat_size(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = STRING_1; char buff1[0xF00] = STRING_2; char buff2[0xF00] = STRING_2; size_t max = 0;
					strlcat(buff1, str, max);
					ft_strlcat(buff2, str, max);
					if (!strcmp(buff1, buff2)) exit(TEST_SUCCESS);
					SET_DIFF(buff1, buff2);
...
void	test_ft_strlcat_empty1(void *ptr)
{
	typeof(strlcat) *ft_strlcat = ptr;
	SET_EXPLANATION("your strcat does not work with empty string as first parameter");
	SANDBOX_RAISE(char *str = ""; char buff1[0xF00] = STRING_2; char buff2[0xF00] = STRING_2; size_t max = strlen(STRING_2)
		+ 1;
					strlcat(buff1, str, max);
					ft_strlcat(buff2, str, max);
					if (!strcmp(buff1, buff2)) exit(TEST_SUCCESS);
...
void	test_ft_strlcat_empty2(void *ptr)
{
	typeof(strlcat) *ft_strlcat = ptr;
	SET_EXPLANATION("your strcat does not work with empty string as second parameter");
	SANDBOX_RAISE(char *str = STRING_1; char buff1[0xF00] = ""; char buff2[0xF00] = ""; size_t max = strlen(STRING_1)
		+ 1;
					strlcat(buff1, str, max);
					ft_strlcat(buff2, str, max);
					if (!strcmp(buff1, buff2)) exit(TEST_SUCCESS);
...
void	test_ft_strlcat_null_byte(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = "n\0AA"; char buff1[0xF00] = "\0AAAAAAAAAAAAAAAA"; char buff2[0xF00] = "\0AAAAAAAAAAAAAAAA"; size_t max = 10;
					strlcat(buff1, str, max);
					ft_strlcat(buff2, str, max);
					if (!strcmp(buff1, buff2)) exit(TEST_SUCCESS);
					SET_DIFF(buff1, buff2);
...
void	test_ft_strlcat_return_value(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "aaa"; char dst1[20]; char dst2[20]; int ret1; int ret2;
					memset(dst1, 'B', sizeof(dst1));
					memset(dst2, 'B', sizeof(dst2));
					strlcat(dst1, src, 20);
					strlcat(dst1, src, 20);
					...
					if (ret1 == ret2) exit(TEST_SUCCESS);
...
void	test_ft_strchr_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = STRING_1;
					d1 = strchr(src, ' ');
					d2 = ft_strchr(src, ' ');
					if (d1 == d2) exit(TEST_SUCCESS);
					SET_DIFF(d1, d2);
					exit(TEST_FAILED););
}
...
void	test_ft_strchr_unicode(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "īœ˙ˀ˘¯ˇ¸¯.œ«‘––™ª•¡¶¢˜ˀ";
					d1 = strchr(src, L'–');
					d2 = ft_strchr(src, L'–');
					if (d1 == d2) exit(TEST_SUCCESS);
					SET_DIFF(d1, d2);
...
void	test_ft_strchr_zero(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = "there is so \0ma\0ny \0 \\0 in t\0his stri\0ng !\0\0\0\0";
					d1 = strchr(src, '\0');
					d2 = ft_strchr(src, '\0');
					if (d1 == d2) exit(TEST_SUCCESS);
					SET_DIFF(d1, d2);
...
void	test_ft_strchr_electric_memory(void *ptr)
{
	...
	SANDBOX_RAISE(char *src = electric_alloc(10);
...
void	test_ft_strchr_null(void *ptr)
{
	...
	SANDBOX_IRAISE(ft_strchr(NULL, '\0');)
}

void	test_ft_strchr_speed(void *ptr)
{
	typeof(strchr) *ft_strchr = ptr;
	SANDBOX_SPEED(size_t size = BFSIZE * 16; char *src = malloc(size + 1);
					memset(src, 'A', size);
					src[size] = 0;
					, strchr(src, 'B');
					, ft_strchr(src, 'B'););
...
void	test_ft_strrchr_basic2(void *ptr)
{
	...
	typeof(strrchr) *ft_strrchr = ptr;
	SET_EXPLANATION("your strrchr does not work with basic input");
	SANDBOX_RAISE(char *src = "abbbbbbbb";
					d1 = strrchr(src, 'a');
					d2 = ft_strrchr(src, 'a');
					if (d1 == d2) exit(TEST_SUCCESS);
					SET_DIFF(d1, d2);
...
void	test_ft_strrchr_null(void *ptr)
{
	...
	typeof(strrchr) *ft_strrchr = ptr;
	SANDBOX_IRAISE(ft_strrchr(NULL, '\0');)
}
...
void	test_ft_strstr_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "FF"; char *s2 = "see FF your FF return (FF now FF");
					i1 = strstr(s1, s2);
					i2 = ft_strstr(s1, s2);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strstr_basic2(void *ptr)
{
	...
	typeof(strstr) *ft_strstr = ptr;
	SET_EXPLANATION("your strstr does not work with basic input");
	SANDBOX_RAISE(char *s1 = "MZIRIBMZIRIBMZP"; char *s2 = "MZIRIBMZP";
					i1 = strstr(s1, s2);
					i2 = ft_strstr(s1, s2);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strstr_basic3(void *ptr)
{
	...
	typeof(strstr) *ft_strstr = ptr;
	SET_EXPLANATION("your strstr does not work with basic input");
	SANDBOX_RAISE(char *s2 = "FF"; char *s1 = "see F your F return (FF now FF");
					i1 = strstr(s1, s2);
					i2 = ft_strstr(s1, s2);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strstr_basic4(void *ptr)
{
	...
	typeof(strstr) *ft_strstr = ptr;
	SET_EXPLANATION("your strstr does not work with basic input");
	SANDBOX_RAISE(char *s1 = "FF"; char *s2 = "see F your F return (F now FF");
					i1 = strstr(s1, s2);
					i2 = ft_strstr(s1, s2);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strstr_basic5(void *ptr)
{
	...
	typeof(strstr) *ft_strstr = ptr;
	SET_EXPLANATION("your strstr does not work with basic input");
	SANDBOX_RAISE(char *s1 = "aaabbbaaabbb"; char *s2 = "abbaaab";
					i1 = strstr(s1, s2);
					i2 = ft_strstr(s1, s2);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strstr_unicode(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "こんにちは"; char *s2 = "にち";
					i1 = strstr(s1, s2);
					i2 = ft_strstr(s1, s2);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strstr_not_found(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "can't found that"; char *s2 = "in this !";
					i1 = strstr(s1, s2);
					i2 = ft_strstr(s1, s2);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strstr_zero_len1(void *ptr)
{
	...
	typeof(strstr) *ft_strstr = ptr;
	SET_EXPLANATION("your strstr does not work with empty strings");
	SANDBOX_RAISE(char *s1 = ""; char *s2 = "oh no not the empty string !";
					i1 = strstr(s1, s2);
					i2 = ft_strstr(s1, s2);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strstr_zero_len2(void *ptr)
{
	...
	typeof(strstr) *ft_strstr = ptr;
	SET_EXPLANATION("your strstr does not work with empty strings");
	SANDBOX_RAISE(char *s1 = "oh no not the empty string !"; char *s2 = "";
					i1 = strstr(s1, s2);
					i2 = ft_strstr(s1, s2);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strstr_same_ptr(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "AAAAAAAAAAAAA";
					i1 = strstr(s1, s1);
					i2 = ft_strstr(s1, s1);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strstr_bad_boyer_moore(void *ptr)
{
	...
	typeof(strstr) *ft_strstr = ptr;
	SET_EXPLANATION("your strstr does not work with basic input");
	SANDBOX_RAISE(char *s1 = "Z"; char *s2 = "A";
					i1 = strstr(s1, s2);
					i2 = ft_strstr(s1, s2);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strstr_electric_memory(void *ptr)
{
	...
	SANDBOX_RAISE(const size_t size = 20; char *s1 = electric_alloc(size); char *s2 = electric_alloc(size);
...
void	test_ft_strstr_null1(void *ptr)
{
	...
	SANDBOX_IRAISE(ft_strstr(NULL, "fake"););
}
...
void	test_ft_strstr_null2(void *ptr)
{
	typeof(strstr) *ft_strstr = ptr;
	SET_EXPLANATION("your strstr does not segfault when null parameter is sent");
	SANDBOX_IRAISE(ft_strstr("fake", NULL););
}

void	test_ft_strstr_speed(void *ptr)
{
	typeof(strstr) *ft_strstr = ptr;
	SANDBOX_SPEED(size_t size = BFSIZE * 4; char *s1 = malloc(size
			+ 1); char *s2 = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAB";
					memset(s1, 'A', size);
					s1[size] = 0;
					, strstr(s1, s2);
					, ft_strstr(s1, s2););
...
void	test_ft_strnstr_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "see FF your FF return (FF now FF"); char *s2 = "FF"; size_t max = strlen(s1);
...
void	test_ft_strnstr_basic2(void *ptr)
{
	...
	typeof(strnstr) *ft_strnstr = ptr;
	SET_EXPLANATION("your strnstr does not work with basic input");
	SANDBOX_RAISE(char *s1 = "FF"; char *s2 = "see F your F return (F now F"); size_t max = strlen(s2);
					i1 = strnstr(s1, s2, max);
					i2 = ft_strnstr(s1, s2, max);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strnstr_basic3(void *ptr)
{
	...
	typeof(strnstr) *ft_strnstr = ptr;
	SET_EXPLANATION("your strnstr does not work with basic input");
	SANDBOX_RAISE(char *s1 = "MZIRIBMZIRIBMZE123"; char *s2 = "MZIRIBMZE"; size_t max = strlen(s2);
					i1 = strnstr(s1, s2, max);
					i2 = ft_strnstr(s1, s2, max);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strnstr_basic4(void *ptr)
{
	...
	typeof(strnstr) *ft_strnstr = ptr;
	SET_EXPLANATION("your strnstr does not work with basic input");
	SANDBOX_RAISE(char *big = "abcdef"; char *little = "abcdefghijklmnop"; size_t max = strlen(big);
					s1 = strnstr(big, little, max);
					s2 = ft_strnstr(big, little, max);
					if (s1 == s2) exit(TEST_SUCCESS);
					SET_DIFF(s1, s2);
					exit(TEST_FAILED););
}
...
void	test_ft_strnstr_basic5(void *ptr)
{
	...
	typeof(strnstr) *ft_strnstr = ptr;
	SET_EXPLANATION("your strnstr does not work with basic input");
	SANDBOX_RAISE(char *big = "123456789"; char *little = "9"; size_t max = 8;
					s1 = strnstr(big, little, max);
					s2 = ft_strnstr(big, little, max);
					if (s1 == s2) exit(TEST_SUCCESS);
					SET_DIFF(s1, s2);
...
void	test_ft_strnstr_zero_len1(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = ""; char *s2 = "oh no not the empty string !"; size_t max = strlen(s2);
					i1 = strnstr(s1, s2, max);
					i2 = ft_strnstr(s1, s2, max);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strnstr_zero_len2(void *ptr)
{
	...
	typeof(strnstr) *ft_strnstr = ptr;
	SET_EXPLANATION("your strnstr does not work with empty strings");
	SANDBOX_RAISE(char *s1 = "oh no not the empty string !"; char *s2 = ""; size_t max = strlen(s1);
					i1 = strnstr(s1, s2, max);
					i2 = ft_strnstr(s1, s2, max);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strnstr_zero_len3(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "oh no not the empty string !"; char *s2 = ""; size_t max = 0;
					i1 = strnstr(s1, s2, max);
					i2 = ft_strnstr(s1, s2, max);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strnstr_same_ptr(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "AAAAAAAAAAAAA"; size_t max = strlen(s1);
...
void	test_ft_strnstr_overlen(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "A"; size_t max = strlen(s1) + 1;
					i1 = strnstr(s1, s1, max);
					i2 = ft_strnstr(s1, s1, max);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF(i1, i2);
...
void	test_ft_strnstr_null1(void *ptr)
{
	...
	SANDBOX_IRAISE(ft_strnstr(NULL, "fake", 3););
}
...
void	test_ft_strnstr_null2(void *ptr)
{
	typeof(strnstr) *ft_strnstr = ptr;
	SET_EXPLANATION("your strnstr does not segfault when null parameter is sent");
	SANDBOX_IRAISE(ft_strnstr("fake", NULL, 3););
}
...
void	test_ft_strnstr_speed(void *ptr)
{
	...
	SANDBOX_SPEED(size_t size = BFSIZE
		* 4; char *s2 = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAB"; char *s1 = malloc(size
			+ 1);
					memset(s1, 'A', size);
					s1[size] = 0;
					, strnstr(s1, s2, size);
...
void	test_ft_strnstr_null3(void *ptr)
{
	...
	SANDBOX_RAISE(ft_strnstr(NULL, "fake", 0); exit(TEST_SUCCESS););
}
...
void	test_ft_strcmp_basic1(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = STRING_1; char *s2 = STRING_2;
					i1 = REG(strcmp(s1, s2));
...
void	test_ft_strcmp_basic2(void *ptr)
{
	...
	typeof(strcmp) *ft_strcmp = ptr;
	SET_EXPLANATION("your strcmp does not work with basic input");
	SANDBOX_RAISE(char *s1 = "omg1"; char *s2 = "omg3";
					i1 = REG(strcmp(s1, s2));
					i2 = REG(ft_strcmp(s1, s2));
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_strcmp_basic4(void *ptr)
{
	...
	typeof(strcmp) *ft_strcmp = ptr;
	SET_EXPLANATION("your strcmp does not work with basic input");
	SANDBOX_RAISE(char *s1 = "AAAAAAAAAB"; char *s2 = "AAAAAAAAAC";
					i1 = REG(strcmp(s1, s2));
					i2 = REG(ft_strcmp(s1, s2));
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_strcmp_after_0(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "yolo!\0B"; char *s2 = "yolo!\0A";
					i1 = REG(strcmp(s1, s2));
					i2 = REG(ft_strcmp(s1, s2));
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_strcmp_zero1(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "AAAAAA"; char *s2 = "";
					i1 = REG(strcmp(s1, s2));
					i2 = REG(ft_strcmp(s1, s2));
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_strcmp_zero2(void *ptr)
{
	...
	typeof(strcmp) *ft_strcmp = ptr;
	SET_EXPLANATION("your strcmp does not work with zero length string");
	SANDBOX_RAISE(char *s1 = ""; char *s2 = "AAAAAA";
					i1 = REG(strcmp(s1, s2));
					i2 = REG(ft_strcmp(s1, s2));
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_strcmp_unsigned(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "\0"; char *s2 = "\200";
					i1 = REG(strcmp(s1, s2));
					i2 = REG(ft_strcmp(s1, s2));
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_strcmp_ascii(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "\x12\xff\x65\x12\xbd\xde\xad"; char *s2 = "\x12\x02";
					i1 = REG(strcmp(s1, s2));
					i2 = REG(ft_strcmp(s1, s2));
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_strcmp_electric_memory(void *ptr)
{
	...
	SANDBOX_RAISE(const size_t size = 10; char *s1 = electric_alloc(size); char *s2 = electric_alloc(size);
					strcpy(s1, "{'-_-'} !");
					strcpy(s2, "{'-_-'} !");
					mprotect(s1 - 4096 + size, 4096, PROT_READ);
					mprotect(s2 - 4096 + size, 4096, PROT_READ);
...
void	test_ft_strcmp_null1(void *ptr)
{
	...
	SANDBOX_IRAISE(ft_strcmp(NULL, "nope"););
}
...
void	test_ft_strcmp_null2(void *ptr)
{
	typeof(strcmp) *ft_strcmp = ptr;
	SET_EXPLANATION("your strcmp does not segfault when null parameter is sent");
	SANDBOX_IRAISE(ft_strcmp("nope", NULL); ft_strcmp(NULL, NULL););
}
...
void	test_ft_strncmp_basic1(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = STRING_1; char *s2 = STRING_2; size_t size = strlen(STRING_1);
...
void	test_ft_strncmp_basic2(void *ptr)
{
	...
	typeof(strncmp) *ft_strncmp = ptr;
	SET_EXPLANATION("your strncmp does not work with basic input");
	SANDBOX_RAISE(char *s1 = "omg1||||||||||||||||"; char *s2 = "omg3"; size_t size = 4;
					i1 = REG(strncmp(s1, s2, size));
					i2 = REG(ft_strncmp(s1, s2, size));
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_strncmp_basic4(void *ptr)
{
	...
	typeof(strncmp) *ft_strncmp = ptr;
	SET_EXPLANATION("your strncmp does not work with basic input");
	SANDBOX_RAISE(char *s1 = "AAAAAAAAA1"; char *s2 = "AAAAAAAAA2";
...
void	test_ft_strncmp_cast(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "\200"; char *s2 = "\0";
					i1 = REG(strncmp(s1, s2, 1));
					i2 = REG(ft_strncmp(s1, s2, 1));
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_strncmp_over_len(void *ptr)
{
	...
	typeof(strncmp) *ft_strncmp = ptr;
	SET_EXPLANATION("your strncmp does not work with basic input");
	SANDBOX_RAISE(char *s1 = "omg1"; char *s2 = "omg3                "; size_t size = 100000;
					i1 = REG(strncmp(s1, s2, size));
					i2 = REG(ft_strncmp(s1, s2, size));
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_strncmp_ascii(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "\x12\xff\x65\x12\xbd\xde\xad"; char *s2 = "\x12\x02"; size_t size = 6;
					i1 = REG(strncmp(s1, s2, size));
					i2 = REG(ft_strncmp(s1, s2, size));
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_strncmp_biglittle(void *ptr)
{
	...
	SANDBOX_RAISE(char *big = "abcdef"; char *little = "abcdefghijklmnop"; size_t size = 6;
...
void	test_ft_strncmp_null1(void *ptr)
{
	...
	SANDBOX_IRAISE(ft_strncmp(NULL, "nope", 3););
}
...
void	test_ft_strncmp_null2(void *ptr)
{
	typeof(strncmp) *ft_strncmp = ptr;
	SET_EXPLANATION("your strncmp does not segfault when null parameter is sent");
	SANDBOX_IRAISE(ft_strncmp("nope", NULL, 3); ft_strncmp(NULL, NULL, 3););
}
...
void	test_ft_atoi_rand(void *ptr)
{
	...
	SANDBOX_RAISE(srand(clock()); for (int i = 0; i < 100; i++) {
		sprintf(n, "%i", rand());
		i1 = atoi(n);
		i2 = ft_atoi(n);
		if (i1 != i2)
...
void	test_ft_atoi_string(void *ptr)
{
	...
	typeof(atoi) *ft_atoi = ptr;
	SET_EXPLANATION("your atoi is not working with blanks");
	SANDBOX_RAISE(char *n = "-123THERE IS A NYANCAT UNDER YOUR BED";
					i1 = atoi(n);
					i2 = ft_atoi(n);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_atoi_max_int(void *ptr)
{
	...
	SANDBOX_RAISE(char n[15]; sprintf(n, "%i", INT_MAX);
					i1 = atoi(n);
					i2 = ft_atoi(n);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_atoi_min_int(void *ptr)
{
	...
	SANDBOX_RAISE(char n[15]; sprintf(n, "%i", INT_MIN);
					i1 = atoi(n);
					i2 = ft_atoi(n);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_atoi_max_long(void *ptr)
{
	...
	SANDBOX_RAISE(char n[40]; sprintf(n, "%li", LONG_MAX);
					i1 = atoi(n);
					i2 = ft_atoi(n);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_atoi_min_long(void *ptr)
{
	...
	SANDBOX_RAISE(char n[40]; sprintf(n, "%li", LONG_MIN);
					i1 = atoi(n);
					i2 = ft_atoi(n);
					if (i1 == i2) exit(TEST_SUCCESS);
					SET_DIFF_INT(i1, i2);
...
void	test_ft_atoi_speed(void *ptr)
{
	typeof(atoi) *ft_atoi = ptr;
	SET_EXPLANATION("your atoi does not work with random numbers");
	SANDBOX_SPEED(char *nbrs = malloc(BFSIZE * 4);
					srand(clock());
					for (int i = 0; i < 10000; i++) sprintf(nbrs + (i * 14),
						"%-11i", rand());
					, for (int i = 0; i < 10000; i++) atoi(nbrs + (i * 14));
					, for (int i = 0; i < 10000; i++) ft_atoi(nbrs + (i
							* 14)););
}
...
void	test_ft_isalpha_(void *ptr)
{
	...
	SANDBOX_RAISE(int i; i = -1; while (i < 530) {
...
void	test_ft_toupper_(void *ptr)
{
	...
	SANDBOX_RAISE(int i = 0;
					while (i < 256) {
						...
						{
							SET_DIFF_CUSTOM("%12s: |%i|\n%12s: |%i|\nparam: (%i)",
								current_fun_name + 3, toupper(i),
								current_fun_name, ft_toupper(i), i)
							exit(TEST_FAILED);
						}
						i++;
					} exit(TEST_SUCCESS););
...
void	test_ft_tolower_(void *ptr)
{
	...
	SANDBOX_RAISE(int i = 0;
					while (i < 256) {
						...
						{
							SET_DIFF_CUSTOM("%12s: |%i|\n%12s: |%i|\nparam: (%i)",
								current_fun_name + 3, tolower(i),
								current_fun_name, ft_tolower(i), i)
							exit(TEST_FAILED);
						}
						i++;
					} exit(TEST_SUCCESS););
...
void	test_ft_memalloc_free(void *ptr)
{
	...
	SANDBOX_RAISE(free(ft_memalloc(42)););
}
...
void	test_ft_memalloc_zero(void *ptr)
{
	...
	SANDBOX_RAISE(size_t size = 514; char *cmp = malloc(size); int diff;
					MALLOC_MEMSET;
...
void	test_ft_memalloc_too_big(void *ptr)
{
	...
	SANDBOX_RAISE(char *ret = ft_memalloc(ULONG_MAX);
					if (!ret) exit(TEST_SUCCESS);
...
void	test_ft_memalloc_size(void *ptr)
{
	...
	void *(*ft_memalloc)(size_t) = ptr;
	SET_EXPLANATION("your memalloc does not set allocated mem to 0");
	SANDBOX_RAISE(size_t size = 514; int ret_size;
					MALLOC_SIZE;
					ret = ft_memalloc(size);
					MALLOC_RESET;
					ret_size = get_last_malloc_size();
					free(ret);
					if (ret_size == (int)size) exit(TEST_SUCCESS);
					SET_DIFF_INT((int)size, ret_size) exit(TEST_SUCCESS););
}
...
void	test_ft_memalloc_malloc_size(void *ptr)
{
	...
	SANDBOX_RAISE(int alloc_size = 42; int size;
					MALLOC_SIZE;
					ft_memalloc(alloc_size);
					MALLOC_RESET;
					size = get_last_malloc_size();
					if (size == alloc_size) exit(TEST_SUCCESS);
...
void	test_ft_memdel_test(void *ptr)
{
	...
	(ft_memdel)(void ) = ptr;
	SANDBOX_RAISE(void *m = malloc(42);
					ft_memdel(&m);
					if (m == NULL) exit(TEST_SUCCESS);
					SET_DIFF_PTR(NULL, m);
					exit(TEST_FAILED););
}
...
void	test_ft_memdel_free(void *ptr)
{
	...
	SANDBOX_RAISE(STDOUT_TO_BUFF; void *m = malloc(42); ft_memdel(&m); if (m != NULL) free(m); write(1,
			"", 1); VOID_STDOUT;);
}
...
void	test_ft_strnew_free(void *ptr)
{
	...
	SANDBOX_RAISE(free(ft_strnew(42)););
}
...
void	test_ft_strnew_zero(void *ptr)
{
	...
	SANDBOX_RAISE(size_t size = 514; MALLOC_MEMSET; char *ret = ft_strnew(size); MALLOC_RESET;
...
void	test_ft_strnew_size(void *ptr)
{
	...
	SANDBOX_RAISE(size_t size = 514; int ret_size;
					...
					MALLOC_RESET;
					ret_size = get_last_malloc_size();
					if (ret_size == (int)size + 1) exit(TEST_SUCCESS);
					free(ret);
...
void	test_ft_strdel_free(void *ptr)
{
	...
	SANDBOX_RAISE(STDOUT_TO_BUFF; void *m = malloc(42); ft_strdel(&m); if (m != NULL) free(m); write(1,
			"", 1); VOID_STDOUT;);
}
...
void	test_ft_strclr_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char b[] = "strclr test !\r\n"; char n[0xF0]; size_t size = strlen(b);
					memset(n, 0, size);
					ft_strclr(b);
					if (!memcmp(b, n, size)) exit(TEST_SUCCESS);
...
void	test_ft_striter_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char b[] = "override this !"; char b2[0xF0]; size_t size = strlen(b);
					for (size_t i = 0; i < size; i++) f_striter(b2 + i);
					b2[size] = 0;
					ft_striter(b, f_striter);
					if (!strcmp(b, b2)) exit(TEST_SUCCESS);
					SET_DIFF(b, b2);
					exit(TEST_FAILED););
}
...
void	test_ft_striter_electric_memory(void *ptr)
{
	...
	SANDBOX_RAISE(const size_t size = 10; char *b = electric_alloc(size);
					strcpy(b, "123456789");
					ft_striter(b, f_striter);
					exit(TEST_SUCCESS););
}
...
void	test_ft_striter_null1(void *ptr)
{
	...
	SANDBOX_PROT(ft_striter(NULL, f_striter));
}
...
void	test_ft_striter_null2(void *ptr)
{
	...
	(ft_striter)(char , void ()(char )) = ptr;
	SET_EXPLANATION("your striter does not segfault when null parameter is sent");
	SANDBOX_PROT(ft_striter("you should not ...", NULL););
}
...
void	test_ft_striteri_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char b[] = "override this !"; char b2[0xF0]; size_t size = strlen(b);
					for (size_t i = 0; i < size; i++) f_striteri(i, b2 + i);
					b2[size] = 0;
...
void	test_ft_striteri_null1(void *ptr)
{
	...
	SANDBOX_PROT(ft_striteri(NULL, f_striteri));
}
...
void	test_ft_striteri_null2(void *ptr)
{
	...
	(ft_striteri)(char , void ()(unsigned, char )) = ptr;
	SET_EXPLANATION("your striteri does not segfault when null parameter is sent");
	SANDBOX_PROT(ft_striteri("you should not ...", NULL); ft_striteri(NULL,
			NULL););
}
...
void	test_ft_strmap_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *b = "override this !"; char b2[0xF0]; size_t size = strlen(b);
					for (size_t i = 0; i < size; i++) b2[i] = f_strmap(b[i]);
					b2[size] = 0;
					ret = ft_strmap(b, f_strmap);
					if (!strcmp(b2, ret)) exit(TEST_SUCCESS);
					SET_DIFF(ret, b2);
					exit(TEST_FAILED););
}
...
void	test_ft_strmap_zero(void *ptr)
{
	...
	SANDBOX_RAISE(char *b = "override this !"; char b2[0xF0]; size_t size = strlen(b);
					...
					ret = ft_strmap(b, f_strmap);
					MALLOC_RESET;
					if (!memcmp(b2, ret, size + 1)) exit(TEST_SUCCESS);
					SET_DIFF(b2, ret);
					exit(TEST_FAILED););
}
...
void	test_ft_strmap_free(void *ptr)
{
	...
	SANDBOX_RAISE(char *b = "override this !"; char b2[0xF0]; size_t size = strlen(b);
					...
					if (!strcmp(newstr, b2)) exit(TEST_SUCCESS);
					free(newstr);
					write(1, "", 1);
					VOID_STDOUT;
					SET_DIFF(b2, newstr);
...
void	test_ft_strmap_size(void *ptr)
{
	...
	SANDBOX_RAISE(char *b = "override this !"; size_t size = strlen(b); int ret_size;
					MALLOC_SIZE;
...
void	test_ft_strmap_malloc_null(void *ptr)
{
	...
	char *(*ft_strmap)(const char *, char (*)(char)) = ptr;
	SET_EXPLANATION("you did not protect your malloc return");
	SANDBOX_RAISE(char *b = "override this !";
					MALLOC_NULL;
					newstr = ft_strmap(b, f_strmap);
					MALLOC_RESET;
					if (newstr == NULL) exit(TEST_SUCCESS);
...
void	test_ft_strmap_null1(void *ptr)
{
	...
	SANDBOX_PROT(ft_strmap(NULL, f_strmap););
}
...
void	test_ft_strmap_null2(void *ptr)
{
	char *(*ft_strmap)(const char *, char (*)(char)) = ptr;
	SET_EXPLANATION("your strmap does not segfault when null parameter is sent");
	SANDBOX_PROT(ft_strmap("olol", NULL); ft_strmap(NULL, NULL););
}
...
void	test_ft_strmapi_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *b = "override this !"; char b2[0xF0]; size_t size = strlen(b);
					for (size_t i = 0; i < size; i++) b2[i] = f_strmapi(i,
							b[i]);
					b2[size] = 0;
...
void	test_ft_strmapi_malloc_size(void *ptr)
{
	...
	SANDBOX_RAISE(char *b = "override this !"; size_t size = strlen(b); size_t alloc_size;
					MALLOC_SIZE;
					ft_strmapi(b, f_strmapi);
					alloc_size = get_last_malloc_size();
					if (alloc_size == size + 1) exit(TEST_SUCCESS);
...
void	test_ft_strmapi_size(void *ptr)
{
	...
	SANDBOX_RAISE(char *b = "override this !"; size_t size = strlen(b); int ret_size;
					...
					MALLOC_RESET;
					ret_size = get_last_malloc_size();
					if ((int)size + 1 == ret_size) exit(TEST_SUCCESS);
					SET_DIFF_INT((int)size + 1, ret_size);
					exit(TEST_KO););
}
...
void	test_ft_strmapi_null1(void *ptr)
{
	...
	SANDBOX_PROT(ft_strmapi(NULL, f_strmapi););
}
...
void	test_ft_strmapi_null2(void *ptr)
{
	char *(*ft_strmapi)(const char *, char (*)(unsigned, char)) = ptr;
	SET_EXPLANATION("your strmapi does not segfault when null parameter is sent");
	SANDBOX_PROT(ft_strmapi("olol", NULL); ft_strmapi(NULL, NULL););
}
...
void	test_ft_strequ_same_pointer(void *ptr)
{
	...
	(ft_strequ)(const char s1, const char s2) = ptr;
	SET_EXPLANATION("your strequ does not work with empty string");
	SANDBOX_RAISE(char *s1 = "NYANCAT INSIDE";
					i1 = ft_strequ(s1, s1);
					if (i1 == 1) exit(TEST_SUCCESS);
					SET_DIFF_INT(0, i1);
					exit(TEST_FAILED););
...
void	test_ft_substr_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = "i just want this part #############"; size_t size = 22;
...
void	test_ft_substr_basic2(void *ptr)
{
	...
	char *(*ft_substr)(const char *, size_t, size_t) = ptr;
	SET_EXPLANATION("your substr does not work with valid input");
	SANDBOX_RAISE(char *str = "i just want this part #############"; size_t size = 20;
...
void	test_ft_substr_zero_len(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = ""; size_t size = 0;
					ret = ft_substr(str, 5, size);
					if (!strncmp(ret, str + 5, size)) {
						free(ret);
						exit(TEST_SUCCESS);
...
void	test_ft_substr_size(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = "i just want this part #############"; size_t size = 10; int ret_size;
					MALLOC_SIZE;
					ft_substr(str, 5, size);
					MALLOC_RESET;
					ret_size = get_last_malloc_size();
					if ((int)size
						+ 1 == ret_size) { exit(TEST_SUCCESS); } SET_DIFF_INT((int)size
						+ 1, ret_size);
					exit(TEST_FAILED););
}
...
void	test_ft_substr_malloc_null(void *ptr)
{
	...
	SANDBOX_RAISE(char *s = "malloc protection !";
					MALLOC_NULL;
					ret = ft_substr(s, 0, 5);
					MALLOC_RESET;
					if (ret == NULL) exit(TEST_SUCCESS);
					SET_DIFF_PTR(NULL, ret);
					exit(TEST_FAILED);
					(void)s;
					(void)ft_substr;);
...
void	test_ft_substr_all(void *ptr)
{
	...
	SANDBOX_RAISE(char *s = "all of this !"; size_t size = strlen(s);
...
void	test_ft_substr_electric_memory(void *ptr)
{
	...
	SANDBOX_RAISE(const size_t size = 10; char *str = electric_alloc(size);
					strcpy(str, "YOLO !!!!");
...
void	test_ft_substr_null(void *ptr)
{
	...
	SANDBOX_PROT(ft_substr(NULL, 0, 12););
}
...
void	test_ft_substr_big_start(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = "01234"; size_t size = 10;
...
void	test_ft_strjoin_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "my favorite animal is"; char *s2 = " "; char *s3 = "the nyancat";
					res = ft_strjoin(ft_strjoin(s1, s2), s3);
					if (!strcmp(res,
							"my favorite animal is the nyancat")) exit(TEST_SUCCESS);
...
void	test_ft_strjoin_overlap(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "my favorite animal is "; char *s2 = s1 + 20;
					res = ft_strjoin(s2, s1);
					if (!strcmp(res,
							"s my favorite animal is ")) exit(TEST_SUCCESS);
...
void	test_ft_strjoin_malloc_null(void *ptr)
{
	...
	char *(*ft_strjoin)(char *, char *) = ptr;
	SET_EXPLANATION("you did not protect your malloc return");
	SANDBOX_RAISE(char *s1 = "where is my "; char *s2 = "malloc ???";
					MALLOC_NULL;
					res = ft_strjoin(s2, s1);
					MALLOC_RESET;
					if (res == NULL) exit(TEST_SUCCESS);
...
void	test_ft_strjoin_zero(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "where is my "; char *s2 = "malloc ???"; char *s3 = "where is my malloc ???";
					MALLOC_MEMSET;
					res = ft_strjoin(s1, s2);
					MALLOC_RESET;
					if (!strcmp(res, s3)) exit(TEST_SUCCESS);
					SET_DIFF(s3, res);
					exit(TEST_FAILED););
}
...
void	test_ft_strjoin_null1(void *ptr)
{
	...
	SANDBOX_PROT(char *s1 = "where is my ";
...
void	test_ft_strtrim_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "   \t  \n\n \t\t  \n\n\nHello \t  Please\n Trim me !\n   \n \n \t\t\n  "; char *s2 = "Hello \t  Please\n Trim me !";
					ret = ft_strtrim(s1, TRIM_SET_PLACEHOLDER);
					if (!strcmp(ret, s2)) exit(TEST_SUCCESS);
					SET_DIFF(s2, ret);
					exit(TEST_FAILED););
}
...
void	test_ft_strtrim_basic3(void *ptr)
{
	...
	char *(*ft_strtrim)(const char *, const char *) = ptr;
	SET_EXPLANATION("your strtrim does not work with basic input");
	SANDBOX_RAISE(char *s1 = "Hello \t  Please\n Trim me !"; char *s2 = "Hello \t  Please\n Trim me !";
					ret = ft_strtrim(s1, TRIM_SET_PLACEHOLDER);
					if (!strcmp(ret, s2)) exit(TEST_SUCCESS);
					SET_DIFF(s2, ret);
					exit(TEST_FAILED););
...
void	test_ft_strtrim_size(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "\t   \n\n\n  \n\n\t    Hello \t  Please\n Trim me !\t\t\t\n  \t\t\t\t  "; char *s2 = "Hello \t  Please\n Trim me !"; int r_size = strlen(s2); int size;
					MALLOC_SIZE;
...
void	test_ft_strtrim_null(void *ptr)
{
	...
	SANDBOX_PROT(char *ret = ft_strtrim(NULL,
			TRIM_SET_PLACEHOLDER); if (!ret) exit(TEST_SUCCESS); SET_DIFF_PTR(NULL,
			ret); exit(TEST_FAILED););
}
...
void	test_ft_split_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *string = "      split       this for   me  !       "; char **expected = ((char *[6]){"split",
			"this", "for", "me", "!", NULL});
...
void	test_ft_split_space(void *ptr)
{
	...
	SANDBOX_RAISE(char **expected = ((char *[1]){NULL}); char *string = "                  ";
					result = ft_split(string, ' ');
					split_cmp_array(expected, result););
}
...
void	test_ft_split_empty(void *ptr)
{
	...
	SANDBOX_RAISE(char *s = ""; char **result = ft_split(s, '\65');
					split_cmp_array(expected, result););
}
...
void	test_ft_split_full(void *ptr)
{
	...
	expected = (char *[2]){NULL};
	SANDBOX_RAISE(char *s = "0 0 0 0 0 0 0 0 0"; char **result = ft_split(s,
			' ');
					split_cmp_array(expected, result););
}
...
void	test_ft_split_free(void *ptr)
{
	...
	SANDBOX_RAISE(char *s = "split 
		||this|for|me|||||!|"; int i = 0; char **result = ft_split(s, '|');
					while (result[i]) {
...
void	test_ft_split_malloc_null(void *ptr)
{
	...
	SANDBOX_RAISE(char *s = "      split       this for   me  !       ";
					MALLOC_NULL;
					result = ft_split(s, ' ');
					MALLOC_RESET;
					if (!result) exit(TEST_SUCCESS);
...
void	test_ft_split_null(void *ptr)
{
	...
	SANDBOX_PROT(char **expected = ft_split(NULL,
			' '); if (!expected) exit(TEST_SUCCESS); SET_DIFF_PTR(NULL,
			expected); exit(TEST_FAILED);)
}
...
void	test_ft_split_terminator(void *ptr)
{
	...
	SANDBOX_RAISE(char **expected = ft_split("\0aa\0bbb",
			'\0'); for (int i = 0; expected[i]; i++) {
		if (expected[i] != NULL)
			exit(TEST_FAILED);
	} exit(TEST_SUCCESS);)
}
...
{
	char	*i1 = ft_itoa(-623); char *i2 = ft_itoa(156); char *i3;

	char *(*ft_itoa)(int) = ptr;
	SET_EXPLANATION("your itoa does not work with basic input");
	SANDBOX_RAISE(
		i1 = ft_itoa(-623); char i2 = ft_itoa(156); char i3 = ft_itoa(-0);
		if (strcmp(i1, "-623")) {
			SET_DIFF("-623", i1);
			exit(TEST_FAILED);
		} if (strcmp(i2, "156")) {
...
void	test_ft_itoa_random(void *ptr)
{
	...
	SANDBOX_RAISE(srand(clock()); int n; char *d;
...
void	test_ft_itoa_max_int(void *ptr)
{
	...
	SANDBOX_RAISE(char *i1 = ft_itoa(INT_MAX);
					if (atoi(i1) != INT_MAX) {
...
void	test_ft_itoa_size(void *ptr)
{
	...
	SANDBOX_RAISE(int size;
					MALLOC_SIZE;
					ft_itoa(-5859);
					MALLOC_RESET;
					size = get_last_malloc_size();
					if (size == 6) exit(TEST_SUCCESS);
					SET_DIFF_INT(6, size);
					exit(TEST_KO););
}
...
void	test_ft_itoa_min_int(void *ptr)
{
	...
	SANDBOX_RAISE(char *i1 = ft_itoa(INT_MIN);
					if (atoi(i1) != INT_MIN) {
...
void	test_ft_itoa_zero_byte(void *ptr)
{
	...
	SANDBOX_RAISE(MALLOC_MEMSET; char *i1 = ft_itoa(-1234); MALLOC_RESET;
					if (strcmp(i1, "-1234")) {
						SET_DIFF("-1234", i1);
						exit(TEST_FAILED);
					} exit(TEST_SUCCESS););
...
void	test_ft_itoa_malloc_null(void *ptr)
{
	char *(*ft_itoa)(int) = ptr;
	SET_EXPLANATION("you did not protect your malloc");
	SANDBOX_RAISE(MALLOC_NULL; char *i1 = ft_itoa(-1234); MALLOC_RESET;
					if (!i1) exit(TEST_SUCCESS);
					SET_DIFF(NULL, i1);
					exit(TEST_FAILED););
}
...
void	test_ft_putchar_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char buff[10]; char c = 'o'; STDOUT_TO_BUFF; ft_putchar(c); GET_STDOUT(buff,
			10); if (buff[0] == c) exit(TEST_SUCCESS); SET_DIFF(buff,
			&c); exit(TEST_FAILED););
}
...
void	test_ft_putchar_ascii(void *ptr)
{
	...
	SANDBOX_RAISE(
		char buff[200]; char buff2[200]; STDOUT_TO_BUFF; for (int i = 0; i < 128; i++) {
			ft_putchar(i);
			buff2[i] = i;
...
void	test_ft_putchar_unicode(void *ptr)
{
	...
	SANDBOX_RAISE(char buff[10]; char buff2[10]; int len = 0;
					i = 0;
					while (haiku_0[i++]) {
						c = haiku_0[i];
...
void	test_ft_putstr_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *buff1 = STRING_1; char buff2[0xF00];
					STDOUT_TO_BUFF;
					ft_putstr(buff1);
					write(1, "", 1);
...
void	test_ft_putstr_ascii(void *ptr)
{
	...
	SANDBOX_RAISE(char *buff1 = "string \x01 of \x63 non \x0a ascii \x12 chars\x1d"; char buff2[0xF00];
					STDOUT_TO_BUFF;
					ft_putstr(buff1);
					write(1, "", 1);
					GET_STDOUT(buff2, sizeof(buff2));
...
void	test_ft_putstr_unicode(void *ptr)
{
	...
	(ft_putstr)(const char ) = ptr;
	SET_EXPLANATION("your putstr does not work with non ascii chars");
	SANDBOX_RAISE(wchar_t *buff1 = L"よくやった"; wchar_t buff2[0xF00];
					//			STDOUT_TO_BUFF;
					ft_putstr((char *)buff1);
					write(1, "", 1);
					//			GET_STDOUT((char*)buff2, sizeof(buff2));
					if (!strcmp((char *)buff1,
							(char *)buff2)) exit(TEST_SUCCESS);
...
void	test_ft_putstr_null(void *ptr)
{
	...
	SANDBOX_PROT(char buff2[0xF00] = {0};
					STDOUT_TO_BUFF;
					ft_putstr(NULL);
					GET_STDOUT(buff2, sizeof(buff2));
					if (!buff2[0]) raise(SIGINT);
					SET_DIFF("(null)", buff2);
					exit(TEST_FAILED););
}
...
void	test_ft_putendl_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char buff1[0xF00] = STRING_1; char buff2[0xF00];
					STDOUT_TO_BUFF;
					ft_putendl(buff1);
					write(1, "", 1);
					GET_STDOUT(buff2, sizeof(buff2));
...
void	test_ft_putendl_ascii(void *ptr)
{
	...
	SANDBOX_RAISE(char buff1[0xF00] = "string \x01 of \x63 non \x0a ascii \x12 chars\x1d"; char buff2[0xF00];
					STDOUT_TO_BUFF;
					ft_putendl(buff1);
					write(1, "", 1);
					GET_STDOUT(buff2, sizeof(buff2));
...
void	test_ft_putendl_unicode(void *ptr)
{
	...
	(ft_putendl)(const char ) = ptr;
	SET_EXPLANATION("your putendl does not work with non ascii chars");
	SANDBOX_RAISE(wchar_t buff1[0xF00] = L"よくやった"; wchar_t buff2[0xF00];
					//			STDOUT_TO_BUFF;
...
void	test_ft_putnbr_basic(void *ptr)
{
	...
	SANDBOX_RAISE(int i = 0; char buff[0xF0];
					STDOUT_TO_BUFF;
					ft_putnbr(i);
					GET_STDOUT(buff, 0xF0);
					if (buff[0] == '0') exit(TEST_SUCCESS);
...
void	test_ft_putnbr_int_max(void *ptr)
{
	...
	SANDBOX_RAISE(int i = INT_MAX; char buff[0xF0];
					STDOUT_TO_BUFF;
					ft_putnbr(i);
					GET_STDOUT(buff, 0xF0);
					if (atoi(buff) == i) exit(TEST_SUCCESS);
					SET_DIFF_INT(i, atoi(buff));
					exit(TEST_FAILED););
}
...
void	test_ft_putnbr_int_min(void *ptr)
{
	...
	SANDBOX_RAISE(int i = INT_MIN; char buff[0xF0];
					STDOUT_TO_BUFF;
					ft_putnbr(i);
					GET_STDOUT(buff, 0xF0);
					if (atoi(buff) == i) exit(TEST_SUCCESS);
...
void	test_ft_putnbr_random(void *ptr)
{
	...
	SANDBOX_RAISE(int nbr; char buff[0xF0];
					srand(clock());
					nbr = rand();
					STDOUT_TO_BUFF;
					ft_putnbr(nbr);
...
void	test_ft_putchar_fd_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char buff[10]; char c = 'o'; STDERR_TO_BUFF; ft_putchar_fd(c,
			STDERR_FILENO); GET_STDERR(buff,
			10); if (buff[0] == c) exit(TEST_SUCCESS); SET_DIFF(&c,
			buff); exit(TEST_FAILED););
}
...
void	test_ft_putchar_fd_ascii(void *ptr)
{
	...
	SANDBOX_RAISE(
		char buff[200]; char buff2[200]; STDERR_TO_BUFF; for (int i = 0; i < 128; i++) {
...
void	test_ft_lstnew_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *data = "hello, i'm a data"; t_list *l = ft_lstnew(data);
					if (!strcmp(data, l->content)) exit(TEST_SUCCESS);
...
void	test_ft_lstnew_free(void *ptr)
{
	...
	STDERR_TO_BUFF;
	SANDBOX_RAISE(char *data = "hello,
		i'm a data"; t_list *l = ft_lstnew(data); write(STDERR_FILENO, "", 1);
...
void	test_ft_lstnew_null(void *ptr)
{
	...
	SANDBOX_RAISE(t_list *l = ft_lstnew(NULL);
					if (!l->content) exit(TEST_SUCCESS);
...
void	test_ft_lstnew_malloc_null(void *ptr)
{
	...
	SANDBOX_RAISE(char *data = "hello, i'm a data";
					MALLOC_NULL;
					l = ft_lstnew(data);
					MALLOC_RESET;
					if (!l) exit(TEST_SUCCESS);
					SET_DIFF_PTR(NULL, l);
					exit(TEST_FAILED););
}
...
void	test_ft_lstdelone_basic(void *ptr)
{
	...
	STDERR_TO_BUFF;
	SANDBOX_RAISE(t_list *l = lstnew(malloc(10));
					g_delone_called = false;
					ft_lstdelone(l, lstdelone_f);
					write(STDERR_FILENO, "", 1);
					if (g_delone_called) exit(TEST_SUCCESS);
					exit(TEST_FAILED););
	VOID_STDERR;
}
...
void	test_ft_lstdelone_nulls(void *ptr)
{
	...
	SANDBOX_PROT(t_list *node = lstnew(malloc(10));
...
void	test_ft_lstclear_basic(void *ptr)
{
	...
	STDERR_TO_BUFF;
	SANDBOX_RAISE(t_list *l = lstnew(strdup("nyancat"));
...
void	test_ft_lstclear_free(void *ptr)
{
	...
	STDERR_TO_BUFF;
	SANDBOX_IRAISE(t_list *l = lstnew(strdup("nyancat")); t_list * tmp;
					l->next = lstnew(strdup("#TEST#"));
					tmp = l->next;
					ft_lstclear(&l, lstdelone_f);
					write(STDERR_FILENO, "", 1);
...
void	test_ft_lstclear_number(void *ptr)
{
	...
	STDERR_TO_BUFF;
	SANDBOX_RAISE(char *content = "hello !";
					__delNum = 0;
					...
					write(STDERR_FILENO, "", 1);
					if (__delNum == 2) exit(TEST_SUCCESS);
...
void	test_ft_lstclear_nulls(void *ptr)
{
	...
	SANDBOX_PROT(t_list *lst = lstnew(malloc(10));
...
void	test_ft_lstadd_front_basic(void *ptr)
{
	...
	STDERR_TO_BUFF;
	SANDBOX_RAISE(t_list *l = lstnew(strdup("nyacat")); t_list *n = lstnew(strdup("OK"));
					ft_lstadd_front(&l, n);
					if (l == n && !strcmp(l->content,
							"OK")) { exit(TEST_SUCCESS); } SET_DIFF_PTR(n, l);
					exit(TEST_FAILED););
	VOID_STDERR;
}
...
void	test_ft_lstadd_front_null(void *ptr)
{
	...
	STDERR_TO_BUFF;
	SANDBOX_RAISE(t_list *l = NULL; t_list *n = lstnew(strdup("OK"));
					ft_lstadd_front(&l, n);
					if (l == n && !strcmp(l->content, "OK")) {
						free(l->next);
						free(l);
...
void	test_ft_lstadd_back_basic(void *ptr)
{
	...
	SANDBOX_RAISE(t_list *l = lstnew(strdup("nyacat")); t_list *n = lstnew(strdup("OK"));
					ft_lstadd_back(&l, n);
					if (l->next == n && !strcmp(l->next->content,
							"OK")) { exit(TEST_SUCCESS); } SET_DIFF_PTR(n, l);
					exit(TEST_FAILED););
	VOID_STDERR;
}
...
void	test_ft_lstsize_basic(void *ptr)
{
	...
	SANDBOX_RAISE(t_list * l; int actual; int expected;
					l = lstnew(strdup("1"));
					l->next = lstnew(strdup("2"));
					l->next->next = lstnew(strdup("3"));
					expected = 3;
					actual = ft_lstsize(l);
					if (actual == expected) exit(TEST_SUCCESS);
...
void	test_ft_lstsize_null(void *ptr)
{
	...
	(ft_lstsize)(t_list ) = ptr;
	SET_EXPLANATION("your lstsize does not work with basic input");
	SANDBOX_RAISE(t_list *l = NULL; int actual; int expected = 0;
					actual = ft_lstsize(l);
					if (actual == expected) exit(TEST_SUCCESS);
					SET_DIFF_INT(expected, actual);
					exit(TEST_FAILED););
...
void	test_ft_lstlast_basic(void *ptr)
{
	...
	SANDBOX_RAISE(t_list * l; t_list * expected; t_list * actual;
					l = lstnew(strdup("1"));
					l->next = lstnew(strdup("2"));
					l->next->next = lstnew(strdup("3"));
...
void	test_ft_lstlast_null(void *ptr)
{
	t_list *(*ft_lstlast)(t_list *) = ptr;
	SET_EXPLANATION("your lstlast does not work with basic input");
	SANDBOX_RAISE(t_list *l = NULL; t_list * expected; t_list * actual;
					expected = NULL;
					actual = ft_lstlast(l);
					if (actual == expected) exit(TEST_SUCCESS);
					SET_DIFF_PTR(expected, actual);
...
void	test_ft_lstiter_basic(void *ptr)
{
	...
	SANDBOX_RAISE(t_list *l = lstnew(strdup("KO !"));
					l->next = lstnew(strdup("KO !"));
					l->next->next = lstnew(strdup("KO !"));
					ft_lstiter(l, lstiter_f);
					if (!strcmp(l->content, "OK !") && !strcmp(l->next->content,
							"OK !") && !strcmp(l->next->next->content,
							"OK !")) exit(TEST_SUCCESS);
...
void	test_ft_lstiter_null(void *ptr)
{
	...
	SANDBOX_PROT(ft_lstiter(NULL, lstiter_f););
}
...
void	test_ft_lstmap_basic(void *ptr)
{
	...
	SANDBOX_RAISE(t_list *l = lstnew(strdup(" 1 2 3 ")); t_list * ret;
					l->next = lstnew(strdup("ss"));
					l->next->next = lstnew(strdup("-_-"));
					// ret = ft_lstmap(l, lstmap_f, NULL); 
						// del may be necessary to use
...
void	test_ft_lstmap_null(void *ptr)
{
	...
	SANDBOX_PROT(ft_lstmap(NULL, lstmap_f, NULL););
}
...
void	test_ft_islower_(void *ptr)
{
	...
	SANDBOX_RAISE(for (int i = -50; i < 530; i++) {
...
void	test_ft_strtrimc_free(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "\x12\x12\x12Hello \t  Please\n Trim me !\x12"; char *s2 = "Hello \t  Please\n Trim me !";
...
void	test_ft_strtrimc_not_found(void *ptr)
{
	...
	SANDBOX_RAISE(char *s1 = "   \t  \n\n \t\t  \n\n\nHello \t  Please\n Trim me !\n   \n \n \t\t\n  ";
					...
					if (!strcmp(s1, ret)) exit(TEST_SUCCESS);
					SET_DIFF(s1, ret);
					exit(TEST_FAILED););
}
...
void	test_ft_strtrimc_null(void *ptr)
{
	...
	SANDBOX_PROT(char *ret = ft_strtrimc(NULL,
			' '); if (!ret) exit(TEST_SUCCESS); SET_DIFF_PTR(NULL,
			ret); exit(TEST_FAILED););
}
...
void	test_ft_strndup_size(void *ptr)
{
	...
	SANDBOX_RAISE(char *tmp = "this is a normal test"; int r_size = 5; int size;
					MALLOC_SIZE;
...
void	test_ft_strndup_null(void *ptr)
{
	...
	SANDBOX_IRAISE(ft_strndup(NULL, 5););
}
...
void	test_ft_strndup_basic2(void *ptr)
{
	typeof(strndup) *ft_strndup = ptr;
	SET_EXPLANATION("your strndup doesn't work with basic input");
	SANDBOX_RAISE(char *str; char *tmp = "I malloc so I am."; char *res = "I m";
...
void	test_ft_atof_basic(void *ptr)
{
	...
	SANDBOX_RAISE(const char *nbr = "0.6588"; double d1; double d2;
					d1 = atof(nbr);
					d2 = ft_atof(nbr);
					if ((float)d1 == (float)d2) exit(TEST_SUCCESS);
...
void	test_ft_atof_negative(void *ptr)
{
	...
	SANDBOX_RAISE(const char *nbr = "-6.6588"; double d1; double d2;
					d1 = atof(nbr);
					d2 = ft_atof(nbr);
					if ((float)d1 == (float)d2) exit(TEST_SUCCESS);
					SET_DIFF_DOUBLE(d1, d2);
...
void	test_ft_atof_random(void *ptr)
{
	...
	SANDBOX_RAISE(char buff[0xF0]; double d1; double d2;
					srand(clock());
					for (int i = 0; i < 1000; i++) {
						sprintf(buff, "%lf", (double)(clock() * rand() / (rand()
									* 10)));
						d1 = atof(buff);
						d2 = ft_atof(buff);
...
void	test_ft_atof_inf_plus(void *ptr)
{
	...
	SANDBOX_RAISE(char buff[0xF00]; double d1; double d2;
...
void	test_ft_atof_zero(void *ptr)
{
	...
	SANDBOX_RAISE(const char *nbr = "0"; double d1; double d2;
					d1 = atof(nbr);
					d2 = ft_atof(nbr);
					if ((float)d1 == (float)d2) exit(TEST_SUCCESS);
					SET_DIFF_DOUBLE(d1, d2);
...
void	test_ft_atof_nan(void *ptr)
{
	...
	SANDBOX_RAISE(char buff[0xF00]; double d1; double d2;
					...
					d1 = atof(buff);
					d2 = ft_atof(buff);
					if (isnan(d1) == isnan(d2)) exit(TEST_SUCCESS);
					SET_DIFF_DOUBLE(d1, d2);
					exit(TEST_FAILED););
}
...
void	test_ft_atof_blanks1(void *ptr)
{
	...
	SANDBOX_RAISE(char *nbr = "  \v\r  \t\n\n\f-9.457787"; double d1; double d2;
					d1 = atof(nbr);
					d2 = ft_atof(nbr);
					if ((float)d1 == (float)d2) exit(TEST_SUCCESS);
					SET_DIFF_DOUBLE(d1, d2);
...
void	test_ft_atof_blanks2(void *ptr)
{
	typeof(atof) *ft_atof = ptr;
	SET_EXPLANATION("your atof does not work with blank chars");
	SANDBOX_RAISE(char *nbr = "  \v\r  \t\n\n\f+42.442422f    "; double d1; double d2;
					d1 = atof(nbr);
					d2 = ft_atof(nbr);
					if ((float)d1 == (float)d2) exit(TEST_SUCCESS);
					SET_DIFF_DOUBLE(d1, d2);
...
void	test_ft_atof_max(void *ptr)
{
	...
	SANDBOX_RAISE(char nbr[0xF000]; double d1; double d2; sprintf(nbr, "%lf",
			DBL_MAX);
					d1 = atof(nbr);
					d2 = atof(nbr);
					if ((float)d1 == (float)d2) exit(TEST_SUCCESS);
...
void	test_ft_atof_min(void *ptr)
{
	...
	SANDBOX_RAISE(char nbr[0xF0]; double d1; double d2; sprintf(nbr, "%lf",
			DBL_MIN);
					d1 = atof(nbr);
					d2 = ft_atof(nbr);
					if ((float)d1 == (float)d2) exit(TEST_SUCCESS);
...
void	test_ft_atof_exp1(void *ptr)
{
	...
	SANDBOX_RAISE(const char *nbr = "6.6545e+8"; double d1; double d2;
					d1 = atof(nbr);
					d2 = ft_atof(nbr);
					if ((float)d1 == (float)d2) exit(TEST_SUCCESS);
					SET_DIFF_DOUBLE(d1, d2);
...
void	test_ft_atof_exp2(void *ptr)
{
	...
	SANDBOX_RAISE(const char *nbr = "4.42125787e-3"; double d1; double d2;
					d1 = atof(nbr);
					d2 = ft_atof(nbr);
					if ((float)d1 == (float)d2) exit(TEST_SUCCESS);
					SET_DIFF_DOUBLE(d1, d2);
...
void	test_ft_strlcpy_basic(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = STRING_1; char buff1[0xF00]; char buff2[0xF00];
					...
					if (!memcmp(buff1, buff2, strlen(str)
							+ 1)) exit(TEST_SUCCESS);
					SET_DIFF(buff1, buff2);
					exit(TEST_FAILED););
}
...
void	test_ft_strlcpy_return(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = STRING_1; char buff1[0xF00]; char buff2[0xF00]; size_t r1; size_t r2;
					r1 = strlcpy(buff1, str, sizeof(buff1));
					r2 = ft_strlcpy(buff2, str, sizeof(buff2));
					if (r1 == r2) exit(TEST_SUCCESS);
					SET_DIFF_INT((int)r1, (int)r2);
					exit(TEST_FAILED););
}
...
void	test_ft_strlcpy_min(void *ptr)
{
	...
	SANDBOX_RAISE(
		str = "hello !"; char buff1[0xF00]; char buff2[0xF00]; size_t r1; size_t r2;
		memset(buff1, 'A', 20);
		memset(buff2, 'A', 20);
		r1 = strlcpy(buff1, str, 2);
		r2 = ft_strlcpy(buff2, str, 2);
		if (r1 == r2 && !memcmp(buff1, buff2, 20)) exit(TEST_SUCCESS);
		if (r1 != r2) { SET_DIFF_INT((int)r1,
			(int)r2); } else { SET_DIFF_BYTES(buff1, buff2,
			20); } exit(TEST_FAILED););
}
...
void	test_ft_strlcpy_zero(void *ptr)
{
	...
	SANDBOX_RAISE(
		str = ""; char buff1[0xF00]; char buff2[0xF00]; size_t r1; size_t r2;
		memset(buff1, 'A', 20);
		memset(buff2, 'A', 20);
		r1 = strlcpy(buff1, str, sizeof(buff1));
		r2 = ft_strlcpy(buff2, str, sizeof(buff2));
...
void	test_ft_strlcpy_overflow(void *ptr)
{
	...
	SANDBOX_RAISE(char *str = "BBBB"; char buff1[0xF00]; char buff2[0xF00];
					memset(buff1, 'A', 20);
					memset(buff2, 'A', 20);
					strlcpy(buff1, str, sizeof(buff1));
					ft_strlcpy(buff2, str, sizeof(buff2));
					if (!memcmp(buff1, buff2, 20)) exit(TEST_SUCCESS);
...
void	test_ft_strlcpy_null(void *ptr)
{
	...
	SANDBOX_IRAISE(ft_strlcpy(NULL, NULL, 10););
}
...
or does not return the size of the string it tried to create");
	SANDBOX_RAISE(char *str = "BBBB"; char buff1[0xF00]; char buff2[0xF00];
					memset(buff1, 'A', 20);
					memset(buff2, 'A', 20);
					if (strlcpy(buff1, str, 0) != ft_strlcpy(buff2, str,
							0)) exit(TEST_FAILED);
					if (!memcmp(buff1, buff2, 20)) exit(TEST_SUCCESS);
					SET_DIFF_BYTES(buff1, buff2, 20);
					exit(TEST_FAILED););
